...
def main():
    ...
    train_features, test_features, feature_cols, cat_features = build_feature_matrix(
    ...
    X_train, X_val, X_full, y_train, y_val, y_val_raw, y_full = pv_based_split(
        modeling_frame, feature_cols, val_fraction=0.04, random_state=42
    )
    ...
    xgb_data = {
        ...
        for k, v in zip(
            ["xgb_train", "xgb_val", "xgb_full", "xgb_test"],
